...
# min-max scaling, and one-hot encoding are encapsulated as interchangeable strategies.
# The transformation logic is separated from the execution logic, allowing feature
# engineering methods to be switched or extended without modifying the core workflow.
